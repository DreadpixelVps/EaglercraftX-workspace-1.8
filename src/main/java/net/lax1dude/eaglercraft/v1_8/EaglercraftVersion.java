...
public class EaglercraftVersion {
	...
	public static final String projectForkVendor = "Itzsplicez";
	...
	public static final String projectOriginAuthor = "Itzsplicez";
	public static final String projectOriginRevision = "1.8";
	public static final String projectOriginVersion = "u53";
	
	public static final String projectOriginURL = "https://gitlab.com/lax1dude/"; // rest in peace
